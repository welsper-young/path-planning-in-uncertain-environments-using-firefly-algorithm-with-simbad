...
public class Simbad extends JFrame implements ActionListener {
    ...
    private void createGUI() {
        ...
        menubar.add(DemoManager.createMenu(this));//Add demo list into the menubar.
        setJMenuBar(menubar);
    }
    ...
    /**
     * Used for Other Output Window.
     * */
    public void addMapWindow(JInternalFrame map) {
    	this.map = map;
    	desktop.add(this.map);
    	this.map.show();
    	this.map.setLocation(400, 20);
    }
    
    /**
     * Used for dispose Other Output Window.
     * */
    private void disposeMapWindow() {
    	if(this.map!=null) {
    		this.map.dispose();
    	}
    }
